            ...
            <img
              src={
                projectWithMilestones.jenis === "Padi"
                  ...
                  ? "/kebuncabai.jpg"
                  : projectWithMilestones.jenis === "Sayuran"
                  ? "/hidroponik_kebun_sayur.jpg"
                  : projectWithMilestones.jenis === "Ayam"
                  ? "/ayam_organik.jpg"
                  : projectWithMilestones.jenis === "Jagung"
                  ? "/jagung.jpg"
                  : projectWithMilestones.jenis === "Kopi"
                  ? "/kopi.jpg"
                  : projectWithMilestones.kategori === "Hortikultura"
                  ? "/hidroponik_kebun_sayur.jpg"
                  : projectWithMilestones.kategori === "Peternakan"
                  ? "/ayam_organik.jpg"
                  : projectWithMilestones.kategori === "Pangan Pokok"
                  ? "/sawah.jpg"
                  : projectWithMilestones.foto || "/sawah.jpg"
              }
